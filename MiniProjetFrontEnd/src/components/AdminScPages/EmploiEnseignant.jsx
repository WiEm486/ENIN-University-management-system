...
//   };
  ...
  return (
    ...
    <h2>Emploi du temps Enseignant</h2>
      ...
      <div style={{display:"flex",gap:"10vw",marginTop:"3vw",marginBottom:"2vh"}}>
      <FormControl>
        ...
        <Table>
          <TableHead style={{  fontWeight: 'bold' }}>
            <TableRow  >
              ...
              <TableCell style={{color: 'white'}}>Spécialité</TableCell>
              <TableCell style={{color: 'white'}}>Groupe</TableCell>
          ...
          <TableBody>
            {filteredEmploiDuTemps.map((emploi) => (
              <TableRow key={emploi.id} style={{ backgroundColor: '#fff', padding: '5px' }}>
                ...
                <TableCell>{emploi.enseignant}</TableCell>
                <TableCell>{emploi.type}</TableCell>
